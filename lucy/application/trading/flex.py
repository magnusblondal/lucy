...
class Flex(Account):
    ...
    def __init__(self, data) -> None:
        ...
        self.initialMarginWithOrders = by_keys(
            data, ["initialMarginWithOrders"])
        ...
        self.totalUnrealizedAsMargin = by_keys(
            data, ["totalUnrealizedAsMargin"])
    ...
    def __str__(self) -> str:
        ...
        return ''.join(currs) +\
            ...
            f'  totUnrealizedAsMargin: {rnd(self.totalUnrealizedAsMargin)}\n' +\
