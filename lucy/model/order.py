...
class Order:
    ...
    def __init__(self, id: Id, position_id: Id, bot_id: Id, symbol: Symbol,
                 qty: float, price: float, order_type: str, side: str,
                 type: str, filled: float, limit_price: float,
                 reduce_only: bool, order_created_at: datetime,
                 last_update_timestamp: datetime, exchange_id: str,
                 created_at: datetime, fills: Fills = None,
                 signal: Signal = None) -> None:
        self.id = Id(id) if isinstance(id, str) else id
        self.position_id = Id(position_id) if isinstance(
            position_id, str) else position_id
