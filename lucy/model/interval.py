...
class Interval(object):
    '''Interval in minutes'''
    allowed_intervals = { 1: "1m", 5: "5m", 15: "15m", 30: "30m", 60: "1h", 240: "4h", 720: "12h", 1440: "1d", 10080: "1w"}
    ...
    def __str__(self):
        postfix = f" ({self.allowed_intervals[self.interval]})" if self.interval >= 60 else ""
    ...
    def resolution(self) -> str:
        '''Returns the resolution of the interval in shorthand notation; (1m, 5m, 15m, 30m, 1h, 4h, 12h, 1d, 1w)'''
