...
class Signal:
    ...
    def __init__(self, id, position_id, bot_id, strategy, ticker, side, signal_type, interval: Interval, 
                 bar_open_time, signal_time, close) -> None:
        self.id = id
        ...
        self.interval = Interval(interval) if isinstance(interval, str) else interval
    ...
    def empty(time: datetime, close: float) -> 'Signal':
        return Signal(None, None, None, None, None, None, None, None, None, time, close)
